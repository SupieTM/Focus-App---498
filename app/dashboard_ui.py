...
if __name__ == "__main__":
    from src.eyeTracker import eyeTracker
    from src.website_blocker import HostsBlocker
else:
    from src.eyeTracker import eyeTracker
    from src.website_blocker import HostsBlocker
...
class App(tk.Tk):
    def __init__(self):
        ...
        self.active_focus_time = 0  # only counts non-paused time
        self.last_resume_time = None
        #Implement website blocker
        self.blocker = HostsBlocker()
        # ---------- PRELOADED THEMES ----------``
        self.themes = {
            "light": {"bg_color": "#ecf0f1", "text_color": "#000000", "start_btn": "#2ecc71", "pause_btn": "#2e60cc",
                      "stop_btn": "#e74c3c", "bg_image": None, "locked": False, "preview": None},
            "dark": {"bg_color": "#2c3e50", "text_color": "#ffffff", "start_btn": "#27ae60", "pause_btn": "#2e60cc",
                     "stop_btn": "#c0392b", "bg_image": None, "locked": False, "preview": None},
            "ocean": {"bg_color": "#1abc9c", "text_color": "#ffffff", "start_btn": "#16a085", "pause_btn": "#2e60cc",
                      "stop_btn": "#c0392b", "bg_image": "src/themes/ocean_theme.png", "locked": True, "preview": "src/themes/ocean_theme.png"},
            "forest": {"bg_color": "#2ecc71", "text_color": "#ffffff", "start_btn": "#27ae60", "pause_btn": "#2e60cc",
                       "stop_btn": "#c0392b", "bg_image": "src/themes/forest_theme.png", "locked": True, "preview": "src/themes/forest_theme.png"},
            "sunset": {"bg_color": "#e67e22", "text_color": "#ffffff", "start_btn": "#d35400", "pause_btn": "#2e60cc",
                       "stop_btn": "#c0392b", "bg_image": "src/themes/sunset_theme.png", "locked": True, "preview": "src/themes/sunset_theme.png"},
            "space": {"bg_color": "#34495e", "text_color": "#ecf0f1", "start_btn": "#2980b9", "pause_btn": "#2e60cc",
                      "stop_btn": "#c0392b", "bg_image": "src/themes/space_theme.png", "locked": True, "preview": "src/themes/space_theme.png"},
        }
    ...
    def set_editable(self, editable):
        ...
        self.site_listbox.config(state=state)
    ...
    def build_main_tab(self):
        ...
        self.noise_slider.config(command=self.update_volume)
    ...
    def start_focus(self):
        # If already focusing → this becomes PAUSE
        if self.is_focusing and not self.is_paused:
            self.pause_focus()
            return

        # If paused → resume
        if self.is_focusing and self.is_paused:
            self.resume_focus()
            return
        ...
        self.is_paused = False
        self.active_focus_time = 0
        self.last_resume_time = time.time()

        self.status_label.config(text="Focusing...")
        self.start_button.config(text="Pause Focus Session", bg=self.themes[self.current_theme]["pause_btn"])
        self.stop_button.config(state="normal")

        # Disable editing DURING active focus
    ...
    def stop_focus(self):
        ...
        if not self.is_paused:
            self.active_focus_time += int(time.time() - self.last_resume_time)

        duration = self.active_focus_time  # only active time counts
        ...
        self.start_button.config(text="Start Focus Session",
        bg=self.themes[self.current_theme]["start_btn"])
    ...
    def pause_focus(self):
        ...
        self.start_button.config(text="Resume Focus Session", bg=self.themes[self.current_theme]["start_btn"])
    ...
    def update_timer(self):
        while self.is_focusing and self.focus_remaining > 0:
            if not self.is_paused and self.timer_enabled.get():
    ...
    def start_white_noise(self):
        if not self.white_noise_playing:
            try:
                pygame.mixer.music.load("src/audio/white_noise.wav")
                pygame.mixer.music.set_volume(self.noise_slider.get() / 100)
